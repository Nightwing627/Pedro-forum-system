...
Route::post('/forum/overview/{id}', 'App\Http\Controllers\FrontendController@getTopics')->name('forum.topics');
...
Route::get('/generate_password/{password}', 'App\Http\Controllers\DashboardController@generate');